...
namespace prework_code_challenges
{
    ...
    public class Challenges
    {
        static void Main(string[] args)
        {
            ...
            {
                string[] challenges = new string[4] { "Array Multiplier", "Leap Year", "Sum of Rows", "Perfect Sequence" };
            ...
            public static int ArrayMultiplier()
            {
                string userName;
            ...
            public static int PerfectSequence()
            {
